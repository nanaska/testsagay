...
export default function RollsMenu ( ) {
    const [content, setContent] = useState([])
    const [rollsFilterType, setRollsFilterType] = useState(null)
    ...
    useEffect(()=>{awdf(2,  null,rollsFilterType )},[rollsFilterType])
    ...
    return(<>
            ...
            <div>
                <div className="dropdown dropdown-end">
                    ...
                    <ul tabIndex="0" className="dropdown-content menu p-2 shadow bg-base-100 rounded-box w-52">
                        <li onClick={()=>{setRollsFilterType(null)}}><a>Всё</a></li>
                        <li onClick={()=>{setRollsFilterType(1)}}><a>Тип 1</a></li>
                        <li onClick={()=>{setRollsFilterType(2)}}><a>Тип 2</a></li>
                        <li onClick={()=>{setRollsFilterType(3)}}><a>Тип 3</a></li>
        ...
        <div className="grid grid-cols-1 min-h-[200px] place-items-center md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5">
            ...
            {content !== undefined && content.map((content,index) =>
                ...
                (content.type ===  2   && <div key={index} type= {2}  className="flex hover:shadow-2xl h-[250px] w-[400px]  md:h-[507px] p-4 rounded md:w-[250px] flex-row md:flex-col items-center justify-center">
